...
function defaultmenu() {
   ...
   switch (menuIndex) {
      case 1:
         ...
         defmenuid = "metll";
         def2menuid = "metme";
         document.getElementById("icon").src = "img/icon2033.ico";
         break;
      case 2:
         menuid = "metll";
         defmenuid = "met33";
         def2menuid = "metme";
         secure = true;
         document.getElementById("icon").src = "img/iconll.png";
         break;
      case 3:
         menuid = "metme";
         defmenuid = "met33";
         def2menuid = "metll";
         secure = true;
         document.getElementById("icon").src = "img/iconexo.ico";
         break;
   }
...
function login() {
   ...
   welcommen.classList.add("text-center");
...
function registerpage() {
   window.location.href = "htmlmellék/register.html";
}
...
function regpass() {
   ...
   if (regUname != "" && regUname != null && regPass.length >= 8) {
      setCookie("username", regUname);
      setCookie("password", regPass);
      window.location.href = "../Játékok.html";
   } else {
